...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Our recommendation: if your wall is white or cream and you need maximum impact — go frontlit. If your wall is dark, or you're in hospitality or luxury retail — go backlit. For both, Emir Ads will provide a digital CGI mockup before production begins.",
      },
    ],
  },
  {
